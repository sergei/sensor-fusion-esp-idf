...
///
/// These structures sit 'on-top-of' the pre-7.0 sensor fusion structures and give us the ability to do Start
...
//SP         spiSlaveSpecificParams_t slaveParams;   ///< SPI specific parameters.  Not used for I2C.
...
typedef struct SensorFusionGlobals
{
	...
	runFusion_t		*runFusion;		///< Start the fusion routines
...
/// HAL operations can be Start successfully.
